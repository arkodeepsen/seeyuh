...
image_keywords = [k.lower() for k in image_keywords]
image_end_keywords = [k.lower() for k in image_end_keywords]
image_edit_keywords = [k.lower() for k in image_edit_keywords]
